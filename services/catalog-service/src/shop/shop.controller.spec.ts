...
describe('ShopController', () => {
  ...
  describe('create', () => {
    it('should create a shop', async () => {
      ...
      expect(mockShopService.create).toHaveBeenCalledWith(
        'seller-1',
        'My Shop',
        'Desc',
      );
  ...
  describe('update', () => {
    it('should update a shop', async () => {
      ...
      await controller.update(mockReq, 's-1', { name: 'New' });
      expect(mockShopService.update).toHaveBeenCalledWith('s-1', 'seller-1', {
        name: 'New',
      });
    });
  });
