...
describe('OrderService', () => {
  ...
  describe('findById', () => {
    ...
    it('should throw NotFoundException if not found', async () => {
      ...
      await expect(service.findById('o-999')).rejects.toThrow(
        NotFoundException,
      );
    });
  });
  ...
  describe('rateSeller', () => {
    ...
    it('should throw ForbiddenException if not the buyer', async () => {
      ...
      await expect(service.rateSeller('o-123', 'buyer-99', 5)).rejects.toThrow(
        ForbiddenException,
      );
    });
  });
  ...
  describe('rateBuyer', () => {
    ...
    it('should throw ForbiddenException if not the seller', async () => {
      ...
      await expect(service.rateBuyer('o-123', 'seller-99', 4)).rejects.toThrow(
        ForbiddenException,
      );
    });
  });
