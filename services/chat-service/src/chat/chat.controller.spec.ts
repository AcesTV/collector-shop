...
describe('ChatController', () => {
  ...
  describe('createConversation', () => {
    it('should create or get conversation', async () => {
      ...
      await controller.createConversation(mockReq, {
        sellerId: 's-1',
        productId: 'p-1',
      });
      expect(mockChatService.getOrCreateConversation).toHaveBeenCalledWith(
        'u-1',
        's-1',
        'p-1',
      );
  ...
  describe('getMessages', () => {
    it('should return messages', async () => {
      ...
      await controller.getMessages('conv-1');
  ...
  describe('moderate', () => {
    it('should moderate a message', async () => {
      ...
      await controller.moderate('msg-1');
