...
describe('FraudController', () => {
  ...
  describe('analyzePriceChange', () => {
    it('should analyze price change', async () => {
      ...
      await controller.analyzePriceChange(body);
  ...
  describe('resolve', () => {
    it('should resolve an alert', async () => {
      ...
      await controller.resolve(mockReq, 'a-1');
