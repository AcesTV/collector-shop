    ...
    return (
      <>
        ...
        >
          <div
            className="card"
            style={{ maxWidth: 500, margin: '0 auto', padding: 48 }}
          >
      ...
      <>
        ...
        >
          ...
          >
            ...
            <p style={{ color: 'var(--color-text-muted)', marginBottom: 24 }}>
              Tu dois avoir le rôle <strong>vendeur</strong> pour publier des
              articles. Contacte un admin pour activer ton compte vendeur.
            </p>
          </div>
        </main>
      </>
        ...
        >
          ...
          >
            ...
            <p style={{ color: 'var(--color-text-muted)' }}>
              Ton article est en attente de modération. Tu seras notifié dès
              qu'il sera validé.
            </p>
            <div
    ...
    <>
      ...
      >
        ...
        <p style={{ color: 'var(--color-text-muted)', marginBottom: 32 }}>
          Remplis les informations ci-dessous. Ton article sera soumis à
        ...
        <form onSubmit={handleSubmit}>
          <div className="card" style={{ marginBottom: 24 }}>
            ...
            <div className="form-group">
              ...
              >
                ⚠️ Les informations personnelles (email, téléphone, liens)
          ...
          <div className="card" style={{ marginBottom: 24 }}>
            <h3 style={{ marginBottom: 16, color: 'var(--color-secondary)' }}>
              💰 Prix
            </h3>
          ...
          <div className="card" style={{ marginBottom: 32 }}>
            <h3 style={{ marginBottom: 16, color: 'var(--color-accent)' }}>
              📸 Images
            </h3>
            <small
              style={{
            ...
            >
              Ajoute jusqu'à 5 URLs d'images de ton article (hébergées sur
              Imgur, etc.)
            </small>

            {imageUrls.map((url, index) => (
              <div
                key={`img-${String(index)}-${url.slice(0, 10)}`}
